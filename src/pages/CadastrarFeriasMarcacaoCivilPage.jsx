...
const API_CADASTRAR_FERIAS_MARCACAO_CIVIL = import.meta.env
  .VITE_API_URL_CADASTRAR_FERIAS_MARCACAO_CIVIL;
...
const API_ATUALIZAR_FERIAS_MARCACAO_CIVIL = import.meta.env
  .VITE_API_URL_ATUALIZAR_FERIAS_MARCACAO_CIVIL;

const API_EXCLUIR_FERIAS_MARCACAO_CIVIL = import.meta.env
  .VITE_API_URL_EXCLUIR_FERIAS_MARCACAO_CIVIL;
...
export function CadastrarFeriasMarcacaoPracaPage() {
  ...
  async function carregarRegistros() {
    try {
      ...
      const data = await apiFetch(
        `${API_LISTAR_FERIAS_MARCACAO_CIVIL_POR_MINUTA}/${idMinuta}`,
        { method: "GET" },
        getValidAccessToken,
      );
  ...
  function handleEditarRegistro(item) {
    ...
    setIdRegistroEdicao(item.id_ferias_marcacao_civil || null);
  ...
  async function handleExcluirRegistro(item) {
    const idRegistro = item.id_ferias_marcacao_civil;
    ...
    try {
      ...
      await apiFetch(
        `${API_EXCLUIR_FERIAS_MARCACAO_CIVIL}/${idRegistro}`,
        { method: "DELETE" },
        getValidAccessToken,
      );
  ...
  async function handleSubmit(event) {
    ...
    try {
      ...
      if (idRegistroEdicao) {
        await apiFetch(
          `${API_ATUALIZAR_FERIAS_MARCACAO_CIVIL}/${idRegistroEdicao}`,
          {
            method: "PUT",
        ...
        await apiFetch(
          API_CADASTRAR_FERIAS_MARCACAO_CIVIL,
          {
            method: "POST",
            body: JSON.stringify(payload),
          },
