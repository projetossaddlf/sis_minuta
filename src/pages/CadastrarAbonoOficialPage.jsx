...
const API_CADASTRAR_ABONO_OFICIAL = import.meta.env
  .VITE_API_URL_CADASTRAR_ABONO_OFICIAL;
...
const API_ATUALIZAR_ABONO_OFICIAL = import.meta.env
  .VITE_API_URL_ATUALIZAR_ABONO_OFICIAL;

const API_EXCLUIR_ABONO_OFICIAL = import.meta.env
  .VITE_API_URL_EXCLUIR_ABONO_OFICIAL;
...
export function CadastrarAbonoOficialPage() {
  ...
  async function carregarRegistros() {
    try {
      ...
      const data = await apiFetch(
        `${API_LISTAR_ABONO_OFICIAL_POR_MINUTA}/${idMinuta}`,
        { method: "GET" },
        getValidAccessToken,
      );
  ...
  function handleEditarRegistro(item) {
    ...
    setIdRegistroEdicao(item.id_abono_oficial || null);
  ...
  async function handleExcluirRegistro(item) {
    const idRegistro = item.id_abono_oficial;
    ...
    try {
      ...
      await apiFetch(
        `${API_EXCLUIR_ABONO_OFICIAL}/${idRegistro}`,
        { method: "DELETE" },
        getValidAccessToken,
      );
  ...
  async function handleSubmit(event) {
    ...
    try {
      ...
      if (idRegistroEdicao) {
        await apiFetch(
          `${API_ATUALIZAR_ABONO_OFICIAL}/${idRegistroEdicao}`,
          {
            method: "PUT",
  ...
  return (
    <div>
      <PageHeader
        title="Abono de Ponto Anual - Oficial"
