...
const API_CADASTRAR_FERIAS_MARCACAO_OFICIAL = import.meta.env
  .VITE_API_URL_CADASTRAR_FERIAS_MARCACAO_OFICIAL;
...
const API_ATUALIZAR_FERIAS_MARCACAO_OFICIAL = import.meta.env
  .VITE_API_URL_ATUALIZAR_FERIAS_MARCACAO_OFICIAL;

const API_EXCLUIR_FERIAS_MARCACAO_OFICIAL = import.meta.env
  .VITE_API_URL_EXCLUIR_FERIAS_MARCACAO_OFICIAL;
...
export function CadastrarFeriasMarcacaoOficialPage() {
  ...
  async function carregarRegistros() {
    try {
      ...
      const data = await apiFetch(
        `${API_LISTAR_FERIAS_MARCACAO_OFICIAL_POR_MINUTA}/${idMinuta}`,
        { method: "GET" },
        getValidAccessToken,
      );
  ...
  function handleEditarRegistro(item) {
    ...
    setIdRegistroEdicao(item.id_ferias_marcacao_oficial || null);
  ...
  async function handleExcluirRegistro(item) {
    const idRegistro = item.id_ferias_marcacao_oficial;
    ...
    try {
      ...
      await apiFetch(
        `${API_EXCLUIR_FERIAS_MARCACAO_OFICIAL}/${idRegistro}`,
        { method: "DELETE" },
        getValidAccessToken,
      );
  ...
  async function handleSubmit(event) {
    ...
    try {
      ...
      if (idRegistroEdicao) {
        await apiFetch(
          `${API_ATUALIZAR_FERIAS_MARCACAO_OFICIAL}/${idRegistroEdicao}`,
          {
            method: "PUT",
        ...
        await apiFetch(
          API_CADASTRAR_FERIAS_MARCACAO_OFICIAL,
          {
            method: "POST",
            body: JSON.stringify(payload),
          },
              ...
              <table className="admin-table">
                ...
                <tbody>
                  {registros.map((item) => (
                    <tr
                      key={
                        item.id_ferias_marcacao_oficial ||
