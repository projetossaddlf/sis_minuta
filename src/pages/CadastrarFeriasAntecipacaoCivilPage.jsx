...
const API_CADASTRAR_FERIAS_ANTECIP_CIVIL = import.meta.env
  .VITE_API_URL_CADASTRAR_FERIAS_ANTECIP_CIVIL;
...
const API_ATUALIZAR_FERIAS_ANTECIP_CIVIL = import.meta.env
  .VITE_API_URL_ATUALIZAR_FERIAS_ANTECIP_CIVIL;

const API_EXCLUIR_FERIAS_ANTECIP_CIVIL = import.meta.env
  .VITE_API_URL_EXCLUIR_FERIAS_ANTECIP_CIVIL;
...
export function CadastrarFeriasAntecipacaoCivilPage() {
  ...
  async function carregarRegistros() {
    try {
      ...
      const data = await apiFetch(
        `${API_LISTAR_FERIAS_ANTECIP_CIVIL_POR_MINUTA}/${idMinuta}`,
        { method: "GET" },
        getValidAccessToken,
      );
  ...
  function handleEditarRegistro(item) {
    ...
    setIdRegistroEdicao(item.id_ferias_antecipacao_civil || null);
  ...
  async function handleExcluirRegistro(item) {
    const idRegistro = item.id_ferias_antecipacao_civil;
    ...
    try {
      ...
      await apiFetch(
        `${API_EXCLUIR_FERIAS_ANTECIP_CIVIL}/${idRegistro}`,
        { method: "DELETE" },
        getValidAccessToken,
      );
  ...
  async function handleSubmit(event) {
    ...
    try {
      ...
      if (idRegistroEdicao) {
        await apiFetch(
          `${API_ATUALIZAR_FERIAS_ANTECIP_CIVIL}/${idRegistroEdicao}`,
          {
            method: "PUT",
        ...
        await apiFetch(
          API_CADASTRAR_FERIAS_ANTECIP_CIVIL,
          {
            method: "POST",
            body: JSON.stringify(payload),
          },
  ...
  return (
    <div>
      <PageHeader
        title="Férias Antecipação - Funcionário Civil"
              ...
              <table className="admin-table">
                ...
                <tbody>
                  {registros.map((item) => (
                    <tr
                      key={
                        item.id_ferias_antecipacao_civil ||
