...
const API_CADASTRAR_FERIAS_REPROG_CIVIL = import.meta.env
  .VITE_API_URL_CADASTRAR_FERIAS_REPROGRAMACAO_CIVIL;

const API_BUSCAR_PESSOA_POR_MATRICULA = import.meta.env
  .VITE_API_URL_BUSCAR_PESSOA_POR_MATRICULA;

const API_LISTAR_FERIAS_REPROG_CIVIL_POR_MINUTA = import.meta.env
  .VITE_API_URL_LISTAR_FERIAS_REPROGRAMACAO_CIVIL_POR_MINUTA;

const API_ATUALIZAR_FERIAS_REPROG_CIVIL = import.meta.env
  .VITE_API_URL_ATUALIZAR_FERIAS_REPROGRAMACAO_CIVIL;

const API_EXCLUIR_FERIAS_REPROG_CIVIL = import.meta.env
  .VITE_API_URL_EXCLUIR_FERIAS_REPROGRAMACAO_CIVIL;
...
export function CadastrarFeriasReprogramacaoCivilPage() {
  ...
  async function carregarRegistros() {
    try {
      ...
      const data = await apiFetch(
        `${API_LISTAR_FERIAS_REPROG_CIVIL_POR_MINUTA}/${idMinuta}`,
        { method: "GET" },
        getValidAccessToken,
      );
  ...
  function handleEditarRegistro(item) {
    ...
    setIdRegistroEdicao(item.id_ferias_reprogramacao_civil || null);
  ...
  async function handleExcluirRegistro(item) {
    const idRegistro = item.id_ferias_reprogramacao_civil;
    ...
    try {
      ...
      await apiFetch(
        `${API_EXCLUIR_FERIAS_REPROG_CIVIL}/${idRegistro}`,
        { method: "DELETE" },
        getValidAccessToken,
      );
  ...
  async function handleSubmit(event) {
    ...
    try {
      ...
      if (idRegistroEdicao) {
        await apiFetch(
          `${API_ATUALIZAR_FERIAS_REPROG_CIVIL}/${idRegistroEdicao}`,
          {
            method: "PUT",
        ...
        await apiFetch(
          API_CADASTRAR_FERIAS_REPROG_CIVIL,
          {
            method: "POST",
            body: JSON.stringify(payload),
          },
  ...
  return (
    <div>
      <PageHeader
        title="Férias Reprogramação - Funcionário Civil"
              ...
              <table className="admin-table">
                ...
                <tbody>
                  {registros.map((item) => (
                    <tr
                      key={
                        item.id_ferias_reprogramacao_civil ||
