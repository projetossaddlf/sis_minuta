...
const API_CADASTRAR_FERIAS_MARCACAO_PRACA = import.meta.env
  .VITE_API_URL_CADASTRAR_FERIAS_MARCACAO_PRACA;
...
const API_ATUALIZAR_FERIAS_MARCACAO_PRACA = import.meta.env
  .VITE_API_URL_ATUALIZAR_FERIAS_MARCACAO_PRACA;

const API_EXCLUIR_FERIAS_MARCACAO_PRACA = import.meta.env
  .VITE_API_URL_EXCLUIR_FERIAS_MARCACAO_PRACA;
...
export function CadastrarFeriasMarcacaoPracaPage() {
  ...
  async function carregarRegistros() {
    try {
      ...
      const data = await apiFetch(
        `${API_LISTAR_FERIAS_MARCACAO_PRACA_POR_MINUTA}/${idMinuta}`,
        { method: "GET" },
        getValidAccessToken,
      );
  ...
  function handleEditarRegistro(item) {
    ...
    setIdRegistroEdicao(item.id_ferias_marcacao_praca || null);
  ...
  async function handleExcluirRegistro(item) {
    const idRegistro = item.id_ferias_marcacao_praca;
    ...
    try {
      ...
      await apiFetch(
        `${API_EXCLUIR_FERIAS_MARCACAO_PRACA}/${idRegistro}`,
        { method: "DELETE" },
        getValidAccessToken,
      );
  ...
  async function handleSubmit(event) {
    ...
    try {
      ...
      if (idRegistroEdicao) {
        await apiFetch(
          `${API_ATUALIZAR_FERIAS_MARCACAO_PRACA}/${idRegistroEdicao}`,
          {
            method: "PUT",
        ...
        await apiFetch(
          API_CADASTRAR_FERIAS_MARCACAO_PRACA,
          {
            method: "POST",
            body: JSON.stringify(payload),
          },
